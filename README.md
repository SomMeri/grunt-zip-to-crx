...
Pem files are generated by OpenSSL from command line:
* Generate password protected `private-key.pem` file: `openssl genrsa -des3 -out private-key.pem 2048`
* Generate `private-key.pem` with no password: `openssl genrsa -out private-key.pem 2048`
